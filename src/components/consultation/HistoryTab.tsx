...
export default function HistoryTab({ patientId }: { patientId: string }) {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-8 xl:gap-12 w-full max-w-[1600px] mx-auto animate-fade-in-up items-start">
      {/* Sidebar Timeline */}
      <div className="w-full md:w-48 lg:w-56 shrink-0 md:sticky md:top-6 md:-ml-8 lg:-ml-16 xl:-ml-24 flex flex-col h-[calc(100dvh-16rem)] max-h-[calc(100dvh-16rem)] pr-2 pb-4">
